		...
		<?php if ( isset( $quiz->id ) ): ?>
			<div id="quiz">
				...
				<form id="form" name="form_quiz">
					...
					<?php endforeach ?>
					<input type="button" value="Enviar" class="button" id="enviar_quiz" />
				</form>
			</div>
		<?php endif ?>
		<a href="teste_online.php"><img src="img/teste-online.jpg" alt="Teste Online" title="Faça um teste online"/></a>
	</div>
</div>
