...
include( "../classes/professoresDAO.php" );
include( "../classes/professores.php" );
# ------------------------------------------------------------------ #
session_start();
# ------------------------------------------------------------------ #
...
{
	$prof = professoresDAO::login( $_POST['email'], $_POST['password'] );
	
	if ( $prof === false )
	{
		$_SESSION['prof_id'] = null;
		$_SESSION['prof_email'] = null;
		$_SESSION['prof_type'] = null;
